	...
	<div id="main">
	      ...
	      <div class="navbar-inner">
	         ...
	         <div class="nav-collapse">
	           <ul id="menu" class="nav">
				...
				<c:if test="${!fns:getUser().channelAdmin}">
	           ...
	           <ul class="nav pull-right">
				 <li><a href="http://www.youyoumob.com" target="_blank" title="游友移动"><i class="icon-home"></i></a></li>
			  	 ...
			  	 <li class="dropdown">
				    ...
				    <ul class="dropdown-menu">
						...
						<c:if test="${fns:getUser().channelAdmin}">
				      	<li><a href="${ctx}/sys/about/customService" target="mainFrame"><i class="icon-envelope"></i>&nbsp;  联系客服</a></li>
						</c:if>
				    </ul>
			  	 </li>
			  	 <li><a href="${ctx}/logout" title="退出登录">退出</a></li>
			  	 <li>
			  	 	<a href="javascript:void(0);">本月订单[数量:${orderCount }&nbsp;金额:${orderPrice }]</a>
			  	 </li>
			  	 <li>&nbsp;</li>
	           </ul>
	         </div><!--/.nav-collapse -->
	    ...
	    <div class="container-fluid">
			<div id="content" class="row-fluid">
				<div id="left"   style="-webkit-overflow-scrolling:touch; overflow: auto;">
					<iframe id="menuFrame" name="menuFrame" src="${ctx}/sys/menu/tree?parentId=${firstMenuId}" style="overflow:visible;"
						scrolling="yes" frameborder="no" width="100%" height="650"></iframe>
				</div>
				<div id="openClose" class="close">&nbsp;</div>
				<div id="right" style="-webkit-overflow-scrolling:touch; overflow: auto;">
					<iframe id="mainFrame" name="mainFrame" src="" style="overflow:visible;"
						scrolling="yes" frameborder="no" width="100%" height="650"></iframe>
				</div>
			</div>
		    <div id="footer" class="row-fluid">
	            Copyright &copy; 2012-${fns:getConfig('copyrightYear')} ${fns:getConfig('productName')} - Powered By <a href="http://www.youyoumob.com" target="_blank">游友移动</a> ${fns:getConfig('version')}
			</div>
		</div>
	</div>
	<script type="text/javascript"> 
