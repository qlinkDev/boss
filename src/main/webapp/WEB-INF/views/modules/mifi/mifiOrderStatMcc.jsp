	...
	<script type="text/javascript">
		...
		$(function(){
			...
			$('#btnSubmit').click(function(){
				$.jBox.tip('正在统计，请稍后...','loading',{id:'aa', persistent: true});
				 $.ajax({
						type: 'post',
						url: '${ctx}/mifi/mifiOrderStat/statByMcc',
...
<body>
	...
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/mifi/mifiOrderStat/mcc">按国家统计</a></li>
		    ...
		    require(
		        ...
		        function(ec) {
		            ...
		            var option = {
	            		title : {
		            		show : true,
		            		text : 'MIFI订单统计【所有国家：订单总数：'+ data.allNum + '  订单总额(￥)：' + data.allToal +'】'
		            	},
		                tooltip : {
		                    trigger: 'axis',
