...
<script type="text/javascript">
	$(function(){
		...
		$("#btnSubmit").click(function(){
			...
			$.ajax({
				type: 'post',
				url: '${ctx}/mifi/usageRecordLog/stat',
				...
				success: function(data){
					...
					$.jBox.tip('统计结果：'+data.msg, tip,{ closed: function () { location.href =  '${ctx}/mifi/usageRecordLog'; } });
...
<body>
	<ul class="nav nav-tabs">
		<li ><a href="${ctx}/mifi/usageRecordLog/list">统计日志列表</a></li>
		<li class="active"><a href="${ctx}/mifi/usageRecordLog/form">统计指定日期</a></li>
	</ul>
	<br />
