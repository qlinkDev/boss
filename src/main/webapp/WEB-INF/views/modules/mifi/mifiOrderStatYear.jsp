		...
		$(function(){
						...
						top.$.jBox.confirm("确认导出？", "操作提示", function(v, h, f) {
							if (v == "ok") {
								$("#searchForm").attr('action',
										"${ctx}/mifi/mifiOrderStat/export1");
								$("#searchForm").submit();
								$("#searchForm").attr('action',
			...
			$('#btnSubmit').click(function(){
				...
				if(begin == "" ||  end == ""){
				 ...
				 $.ajax({
						type: 'post',
						url: '${ctx}/mifi/mifiOrderStat/statByYear',
...
<body>
	...
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/mifi/mifiOrderStat/year">按年统计</a></li>
		<li><a href="${ctx}/mifi/mifiOrderStat/month">按月统计</a></li>
		<li><a href="${ctx}/mifi/mifiOrderStat/day">按日统计</a></li>
	</ul>
	<!-- tab E -->
