...
<head>
	...
	function page(n, s) {
		...
		function scheduled(id, param){
			...
			$.ajax({
				type: 'post',
				url: '${ctx}/mifi/usageRecordLog/getResult',
...
<body>
	...
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/mifi/usageRecordLog/list">统计日志列表</a></li>
		<li><a href="${ctx}/mifi/usageRecordLog/form">统计指定日期</a></li>
	</ul>
	<!-- tab E -->
	
	<!-- 查询 S -->
	<form:form id="searchForm" modelAttribute="mifiUsageRecordLogCondition" action="${ctx}/mifi/usageRecordLog/list" method="post" class="breadcrumb form-search">
