...
<meta name="author" content="http://www.youyoumob.com"/><meta http-equiv="X-UA-Compatible" content="IE=7,IE=9,IE=10" />
...
<link href="${ctxStatic}/common/uframework.min.css" type="text/css" rel="stylesheet" />
<script src="${ctxStatic}/common/uframework.min.js" type="text/javascript"></script>
