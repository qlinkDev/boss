...
<html>
		...
		<script type="text/javascript">
			$(function() {
				...
				$('.maskbtn').click(function() {
					...
					setTimeout('window.location.href = "http://youyoumob.com/Home/Order/valueAdded?mcc=${mcc}"', 300);
	...
	<body>
		...
		<div class="mask" id="mask">
			<div class="maskcon">
				<p class="masktext"><img src="${ctxStaticFront }/youyouauto/css/img/right.png" width="26" alt="" class="mr10"/>联网成功</p>
