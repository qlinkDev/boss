...
public class Generate {
	...
	public static void main(String[] args) throws Exception {
		...
		String packageName = "com.uu.modules";
		
		String moduleName = "pay";			    // 模块名，例：sys
		String subModuleName = "";				// 子模块名（可选） 
		String className = "user";			    // 类名，例：user
		String classAuthor = "admin";		    // 类作者，例：admin
		String functionName = "用户";			// 功能名，例：用户
...
//		Boolean isEnable = true;
		...
		// 模板文件路径
		String tplPath = StringUtils.replace(projectPath+"/src/main/java/com/uu/generate/template", "/", separator);
