 ...
 */
@Entity
@Table(name = "mifi_usage_record")
@DynamicInsert
@DynamicUpdate
public class MifiUsageRecord extends BaseEntity<MifiUsageRecord> {

	private static final long serialVersionUID = -6231318958216501854L;
