...
public class UserController extends BaseController {
	...
	public String list(User user, HttpServletRequest request, HttpServletResponse response, Model model) {
        Page<HashMap> page = systemService.findUserlist(new Page<HashMap>(request, response), user);
	...
	public String form(User user, Model model) {
		...
		if (StringUtils.isBlank(user.getChannelNameEn())) {
			user.setChannelName(UserUtils.getUser().getChannelName());
			user.setChannelNameEn(UserUtils.getUser().getChannelNameEn());
		}
    ...
    public String exportFile(User user, HttpServletRequest request, HttpServletResponse response, RedirectAttributes redirectAttributes) {
		try {
			...
			List<User> list = systemService.findUserListExport(user); 
